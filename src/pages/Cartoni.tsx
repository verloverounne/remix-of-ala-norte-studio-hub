...
const Cartoni = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section with Carousel — full-width like Home */}
      {hasSlides ? (
                      ...
                      <div className="relative z-10 text-center px-4 sm:px-8 max-w-4xl mx-auto">
                        <div className="inline-block backdrop-blur-md bg-foreground/80 px-6 sm:px-12 py-6 sm:py-10 border border-background/20">
                          ...
                          <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
                            ...
                            <Button asChild variant="outline" size="lg" className="text-background border-background/30 hover:bg-background hover:text-foreground">
        ...
        <section className="relative border-b border-border bg-foreground text-background overflow-hidden">
          <div className="py-20 sm:py-28 lg:py-32">
            <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl text-center">
              <img src={CARTONI_LOGO} alt="Cartoni Logo" className="h-16 md:h-24 mx-auto bg-background p-4 rounded-lg mb-8" />
              <h1 className="font-sans font-thin mb-6 uppercase" style={{ fontSize: "clamp(2rem, 5vw, 4rem)" }}>
                SELLER & SERVICE<br />
                <span className="text-primary">OFICIAL CARTONI</span>
              </h1>
              <p className="text-sm md:text-base text-background/80 font-heading mb-8 leading-tight">
                ALA NORTE ES REPRESENTANTE OFICIAL DE CARTONI EN ARGENTINA
              </p>
      ...
      {/* Services Section */}
      <section className="relative border-b border-border py-16 lg:py-24 bg-background">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
          <div className="mb-12">
            <h2 className="font-heading text-3xl md:text-5xl mb-4 uppercase">NUESTROS SERVICIOS</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border border-foreground/10 p-8 bg-card hover:shadow-brutal transition-shadow">
              <div className="h-16 w-16 bg-primary text-background flex items-center justify-center mb-6">
      ...
      {/* About Cartoni */}
      <section className="relative border-b border-border py-16 lg:py-24 bg-muted">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
          <div className="max-w-4xl">
            <div className="mb-12">
              <h2 className="font-heading text-3xl md:text-5xl mb-4 uppercase">SOBRE CARTONI</h2>
              <p className="text-sm text-muted-foreground font-heading leading-tight">
      ...
      {/* Contact CTA */}
      <section className="relative border-b border-border py-16 lg:py-24 bg-foreground text-background">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl text-center">
          <h2 className="font-heading text-3xl md:text-5xl mb-4 uppercase">CONTACTANOS</h2>
          <p className="text-sm text-background/70 mb-8 leading-tight">
