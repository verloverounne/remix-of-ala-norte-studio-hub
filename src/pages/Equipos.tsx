...
const Equipos = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      top: `${stickyTop}px`
        ...
        <div className="container px-4 py-4 mx-[32px] bg-foreground">
          ...
          <div ref={filterRef}>
            <Collapsible open={isFilterOpen} onOpenChange={setIsFilterOpen}>
              <div className="pb-2">
                <button onClick={() => setIsFilterOpen(!isFilterOpen)} className="flex items-center gap-1 font-heading text-xs uppercase transition-colors cursor-pointer text-background">
