            ...
            <Collapsible open={isFilterOpen} onOpenChange={setIsFilterOpen}>
              ...
              <CollapsibleContent>
                <div className="pb-4 mx-0">
                  {filteredSubcategories.length === 0 ? <p className="flex flex-wrap text-xs text-muted-foreground items-center px-2 mb:px-4 lg:px-16">No hay subcategorías para esta categoría</p> : <div className="flex flex-wrap gap-2">
