...
const Equipos = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto py-0 items-center px-0 bg-foreground">
              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "flex-wrap flex-1 py-1.5 font-heading text-xs uppercase transition-all whitespace-nowrap px-[12px] font-bold border-0 rounded-sm ",
                ...
                <div className="pb-4 mx-0">
                  ...
                  <div className="flex flex-wrap gap-2 px-4">
                    ...
                    <button
                      ...
                      className={cn(
                        "flex-1 min-w-fit text-xs font-heading uppercase transition-all text-center px-[12px] py-[4px] bg-muted border border-muted rounded-sm",
          ...
          <div className="flex-wrap flex-1 obje flex items-center justify-center text-background gap-[12px]">
            ...
            <Select value={sortOption} onValueChange={(val) => setSortOption(val as SortOption)}>
              ...
              <SelectContent className="bg-foreground z-50">
      ...
      <div className="container pb-4 sm:pb-6 bg-foreground mx-0 ">
        <div className="grid lg:grid-cols-4 gap-4 lg:gap-6 py-[16px] ml-0 pl-[16px] bg-foreground px-0">
