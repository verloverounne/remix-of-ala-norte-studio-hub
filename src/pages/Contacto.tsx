    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="bg-foreground text-background py-0">
        <div className="container mx-auto max-w-6xl text-left px-0">
          <h1 className="font-sans font-thin my-[64px] mb-[2px] mx-0 ml-[16px]" style={{ fontSize: "clamp(2rem, 5vw, 4rem)" }}>
            Contactanos
          </h1>
          <p className="max-w-3xl text-left font-medium text-base md:text-lg bg-transparent mx-0 px-[16px] py-[32px]">
              ...
              <Card className="flex-1 overflow-hidden">
                <div className="h-full min-h-[400px]">
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2863.34773119655!2d-58.492846624694494!3d-34.52640795341865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcb6ba04dacea7%3A0xe8cc434b9649a6d0!2sAla%20Norte!5e1!3m2!1ses!2sar!4v1779114964151!5m2!1ses!2sar"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
