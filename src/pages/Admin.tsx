    ...
    try {
      ...
      const rows = allEquipment.map((eq: any) => {
        return [
          ...
          eq.order_index,
          eq.image_url,
          JSON.stringify(eq.images || []),
          JSON.stringify(eq.specs || []),
          JSON.stringify(eq.detailed_specs || []),
          eq.category_id,
          eq.categories?.name || "",
          eq.subcategory_id,
          ...
          {editingEquipment && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={(editingEquipment as any).ownership_type || ""}
                  onValueChange={(v) =>
                    setEditingEquipment({
                      ...editingEquipment,
                      ownership_type: v,
              ...
              <div className="space-y-2">
                ...
                <Input
                  value={(editingEquipment as any).functional_status || ""}
                  onChange={(e) =>
                    setEditingEquipment({
                      ...editingEquipment,
                  ...
                  placeholder="Si, No, Parcial..."
                />
              </div>
              <div className="space-y-2">
                <Label>Nro. Serie</Label>
                <Input
                  value={(editingEquipment as any).serial_number || ""}
                  onChange={(e) =>
                    setEditingEquipment({
                      ...editingEquipment,
