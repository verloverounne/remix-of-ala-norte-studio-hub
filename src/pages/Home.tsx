  ...
  return (
    <section className="relative border-y border-border overflow-hidden min-h-[90vh] flex items-center duotone-hover-group">
      ...
      <div className="absolute inset-0 w-full h-full border-0">
        <img
          alt=""
          className="w-full h-full image-duotone border-0 object-cover"
      ...
      <div className="relative z-10 container mx-auto px-4 flex">
        <div
          ref={contentParallax.ref as any}
          style={contentParallax.style}
          className="max-w-2xl p-6 backdrop-blur-lg rounded-lg backdrop-blur-lg py-[68px] mx-[16px] px-[24px]"
        >
