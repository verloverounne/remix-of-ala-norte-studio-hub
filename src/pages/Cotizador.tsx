...
Contactar cliente para coordinar entrega/retiro.
    `.trim();
    if (sendVia === "whatsapp") {
      const whatsappNumber = "5491126824709";
  ...
  return (
    <div className="min-h-screen pt-14 sm:pt-16 bg-background">
      {/* Hero Section */}
      <section className="text-primary-foreground py-12 sm:py-16 lg:py-20 border-b border-border px-4 sm:px-8 bg-foreground">
        <div className="container mx-auto text-left px-0">
          <h1
            className="font-sans font-thin mb-4 sm:mb-6 px-0 my-0 mt-0 mx-0"
      ...
      <section className="py-8 sm:py-12 lg:py-16">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <Card className="mb-6 sm:mb-8 border-2 border-primary bg-primary/5">
            <CardContent className="py-4 sm:py-6 bg-foreground text-background rounded-sm">
              ...
              <CardHeader className="bg-primary/10">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Buscamos que el proceso sea claro y sencillo, desde la consulta inicial hasta la devolución del
                      equipo.
                    </CardDescription>
                  </div>
                  ...
                  <ol className="space-y-3 font-heading">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-sans text-sm text-muted-foreground">
                          Te sugerimos un set de equipamiento en función de tu visión, tu presupuesto y la escala del
                          rodaje.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-sans text-sm text-muted-foreground">
                          Definimos horarios, punto de entrega y condiciones de uso para que llegues al rodaje sin
                          sorpresas.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-sans text-sm text-muted-foreground">
                          Si surge alguna duda con el equipo, estamos disponibles para ayudarte a resolverla.
                        </p>
                      </div>
                    </li>
                  </ol>
                ...
                <div>
                  ...
                  <CardDescription>
                    {items.length === 0
                      ...
                      : `${items.length} ${items.length === 1 ? "equipo" : "equipos"} seleccionados`}
                  </CardDescription>
                </div>
                {items.length > 0 && (
                ...
                <>
                  {unavailableEquipment.size > 0 && (
                    <Alert variant="destructive" className="mb-4">
                      ...
                      <AlertDescription>
                        Algunos equipos no están disponibles en las fechas seleccionadas. Elimínalos del carrito para
                        continuar.
                      </AlertDescription>
                    </Alert>
                  )}
                  {items.map((item) => {
                    ...
                    return (
                      <Card
                        key={item.id}
                        className={`overflow-hidden ${isUnavailable ? "border-destructive border-2" : ""}`}
                      >
          ...
          <Card className="mb-6 sm:mb-8">
            <CardHeader>
              ...
              <CardDescription>Completa tus datos para recibir la cotización.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="company">Empresa / Producción</Label>
                  <Input
                    id="company"
                    name="company"
