  ...
  return <section className="relative h-screen overflow-hidden bg-foreground">
      ...
      <div className="hidden lg:grid lg:grid-cols-2 w-full h-screen">
        ...
        <div className="flex flex-col justify-end h-screen pl-8 pr-8 lg:pl-16 lg:pr-16 pb-[16vh] bg-background">
          <div className="space-y-6 w-full h-full my-[42px] py-[61px]">
            {/* Price Badge */}
        ...
        <div className="absolute inset-0 flex items-end justify-center pb-[64px]">
          <div ref={contentParallax.ref as any} style={contentParallax.style} className="backdrop-blur-lg bg-background/40 rounded-lg mx-4 px-6 py-8 max-w-lg">
            ...
            <div className="flex items-center gap-2 text-primary px-4 py-2 rounded-lg w-fit bg-foreground mb-4">
              ...
              <span className="text-background font-extralight text-xs">
                / bloque {space.block_hours || 4}hs
              </span>
            </div>

            {/* Title */}
            <h1 className="font-heading font-bold text-foreground text-4xl mb-2">
              {space.hero_title || space.name}
            </h1>
