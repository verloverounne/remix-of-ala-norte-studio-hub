      ...
      <div className="hidden lg:grid lg:grid-cols-2 w-full max-h-screen">
        ...
        <div className="flex flex-col justify-center h-screen pl-8 pr-8 lg:pl-16 lg:pr-16 py-[16vh] bg-background">
          <div className="space-y-6 w-full h-full my-0 py-[24px]">
            ...
            {/* Discount */}
            {space.discount_text && (
              <div className="inline-flex items-center gap-2 border-2 border-primary px-4 py-2 rounded-none my-[16px] pb-[9px] mb-[48px] mt-0">
      ...
      <div className="lg:hidden h-screen relative">
        ...
        <div className="absolute inset-0 pb-[64px] flex items-end justify-center">
          ...
          >
            ...
            {/* Location */}
            {space.location && (
              <div className="flex items-center gap-2 rounded-lg border-2 border-foreground px-3 py-1 mb-4 w-fit bg-foreground text-background">
            ...
            {/* Discount */}
            {space.discount_text && (
              <div className="inline-flex items- gap-2 border-2 border-primary px-3 py-1.5 rounded-lg mb-4">
