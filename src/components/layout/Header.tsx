...
export const Header = () => {
  ...
  return (
    <>
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-[55] bg-background border-b border-foreground transition-transform duration-300 ${isMobile ? (mobileMenuOpen ? "translate-y-0" : "-translate-y-full") : isVisible || isHovering ? "translate-y-0" : "-translate-y-full"}`}
        ...
        <nav className="container mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex h-10 lg:h-14 items-center justify-between">
            ...
            <Link to="/" className="hidden lg:flex items-center">
              <img src={logo} alt="Ala Norte" width={48} height={51} className="h-8 lg:h-12 w-auto object-contain" />
            </Link>
