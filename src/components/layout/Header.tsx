            ...
            <div className="flex w-full h-12 items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  {totalItems > 0 && (
                    <span className="absolute -top--1 -right--1 bg-primary text-primary-foreground text-2 rounded-full h-4 w-4 flex items-center justify-center border text-xs font-medium">
                      {totalItems}
                    </span>
                  )}
                </Link>
