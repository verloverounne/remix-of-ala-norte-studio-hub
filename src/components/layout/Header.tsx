...
export const Header = () => {
  ...
  return (
    <>
      ...
      {!isMobile && (
        <header
          className={`fixed top-0 left-0 right-0 z-[65] bg-background/30 border-b border-foreground transition-transform duration-300 ${isVisible || isHovering ? "translate-y-0" : "-translate-y-full"}`}
