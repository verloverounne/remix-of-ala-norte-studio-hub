...
export const Header = () => {
  ...
  return <>
      ...
      {!isMobile && <header className={`fixed top-0 left-0 right-0 z-[65] bg-background border-b border-foreground transition-transform duration-300 ${isVisible || isHovering ? "translate-y-0" : "-translate-y-full"}`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          <nav className="w-full flex items-center justify-center px-4 py-3 backdrop-blur-sm bg-transparent">
            <div className="flex h-10 lg:h-14 items-center justify-center gap-4">
              {/* Logo Brutal */}
              <Link to="/" className="flex items-center">
                <img alt="Ala Norte" className="h-full w-auto object-contain mx-8" src="/lovable-uploads/472c65f1-498e-42ad-8bf6-4d6c063ad971.png" />
              </Link>
