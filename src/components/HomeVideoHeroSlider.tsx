...
export const HomeVideoHeroSlider = () => {
  const [videos, setVideos] = useState<{ id: string; video_url: string; order_index: number }[]>([]);
              ...
              <div className="relative h-screen w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center z-10">
                  <div className="text-center p-4 sm:p-6 lg:p-8 max-w-4xl">
                    <h2 className="font-heading text-background text-3xl sm:text-4xl md:text-5xl lg:text-7xl mb-2 sm:mb-4 font-bold drop-shadow-lg">
                      {slide.title}
                    </h2>
                    ...
                    {slide.cta && (
                      <Button asChild variant="hero" size="lg" className="text-base sm:text-lg">
                        <Link to={slide.cta.link}>{slide.cta.label}</Link>
                      </Button>
                    )}
                  </div>
                </div>
