    ...
    <CarouselItem className="h-screen pl-0">
      ...
      <div className="hidden md:grid md:grid-cols-2 h-screen bg-foreground">
        ...
        <div className="flex flex-col justify-end h-screen pl-8 pr-8 lg:pl-16 lg:pr-16 pb-[16vh] px-0 text-left text-4xl">
          <h1
            className="text-background font-bold mb-4 leading-tight border-0 font-sans"
            style={{
      ...
      <div className="md:hidden h-screen relative">
        ...
        <div className="absolute inset-0 flex items-end justify-center mb-[64px]">
          <div
            ...
            className="backdrop-blur-lg text-center text-background/ px-8 pl-[32px] pb-[32px] my-[16px]"
          >
...
export const HomeVideoHeroSlider = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-8 left-1/2 z-20 my-[0px]6">
        <img src={heroLogo} alt="Ala Norte Logo" className="sticky top-20 h-20 md:h-100 w-auto object-cover" />
      </div>
