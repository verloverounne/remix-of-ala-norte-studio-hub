  ...
  return <CarouselItem className="h-screen pl-0">
      ...
      <div className="md:hidden h-screen relative">
        ...
        <div className="absolute inset-0 flex items-end justify-center mb-[64px]">
          <div ref={contentParallax.ref as any} style={contentParallax.style} className="backdrop-blur-lg text-center text-background/ px-8 pl-[32px] pb-[32px] my-[16px] mx-[16px] bg-foreground">
