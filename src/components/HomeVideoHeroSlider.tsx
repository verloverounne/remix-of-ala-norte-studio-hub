...
const HeroSlideComponent = ({
  ...
  return <CarouselItem className="h-screen pl-0">
      ...
      <div className="hidden md:grid md:grid-cols-2 h-screen bg-foreground">
        ...
        <div className="flex flex-col justify-end h-screen pl-8 pr-8 lg:pl-16 lg:pr-16 pb-[16vh] px-0 text-left text-4xl gap-[24px]">
          <h1 className="text-background font-bold mb-4 leading-tight border-0 font-sans leading-ti" style={{
      ...
      <div className="md:hidden h-screen relative">
        ...
        <div className="absolute inset-0 flex items-end justify-center mb-[64px]">
          <div ref={contentParallax.ref as any} style={contentParallax.style} className="backdrop-blur-lg text-center text-background/ px-8 pl-[32px] pb-[32px] my-[16px] mx-[16px] bg-[#423c38]/50">
...
export const HomeVideoHeroSlider = () => {
  ...
  return <section className="relative h-screen overflow-hidden border-b-4 border-foreground" onMouseDown={handleUserInteraction} onTouchStart={handleUserInteraction}>
      ...
      <div className="absolute top-2 left-0 right-0 z-20 flex justify-center mt-8 md:mt-1 lg:mt-1 lg:mb-12 my-0">
        <img src={heroLogo} alt="Ala Norte Logo" className="sticky object-contain w-28 md:w-1/4 lg:w-1/6 " />
      </div>
      {/* Navigation dots */}
