  ...
  return (
    <CarouselItem className="h-screen pl-0">
      ...
      <div className="hidden md:grid md:grid-cols-2 h-screen bg-foreground">
        ...
        <div className="sticky flex flex-col justify-end h-screen pl-8 pr-8 lg:pl-16 lg:pr-16 pb-[16vh] px-0 text-left text-4xl gap-[24px] bg-accent-foreground bg-foreground">
          <h1
            className="text-background mb-4 leading-tight border-0 font-sans text-6xl font-normal"
            style={{
    ...
    >
      ...
      >
        <Link to="/equipos" className="group relative flex flex-col items-center cursor-pointer mx-[60px]">
          <img
            alt="Ala Norte Logo"
            className="object-contain w-48 md:w-1/4 lg:w-1/5 transition-transform duration-500 group-hover:scale-[1.06]"
