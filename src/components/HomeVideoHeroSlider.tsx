...
export const HomeVideoHeroSlider = () => {
  ...
  return <section className="relative h-screen overflow-hidden border-b-4 border-foreground" onMouseDown={handleUserInteraction} onTouchStart={handleUserInteraction}>
      ...
      <div className="absolute top-2 left-0 right-0 z-20 flex justify-center mt-16 md:mt-px lg:mt-1 lg:mb-12 my-0">
        <img src={heroLogo} alt="Ala Norte Logo" className="object-contain w-100 md:w-1/4 lg:w-1/12 " />
      </div>
      {/* Navigation dots */}
