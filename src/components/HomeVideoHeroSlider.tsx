  ...
  return (
    <CarouselItem className="h-screen pl-0">
      ...
      <div className="hidden md:grid md:grid-cols-2 h-screen bg-foreground">
        ...
        <div className="sticky flex flex-col justify-end h-screen pl-8 pr-8 lg:pl-16 lg:pr-16 pb-[16vh] px-0 text-left text-4xl gap-[24px] bg-accent-foreground bg-white">
          <h1
