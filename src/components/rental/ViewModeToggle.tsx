...
export const ViewModeToggle = ({
  ...
  return <div className="flex items-center border border-foreground/20 rounded-none">
      <Button variant="ghost" size="sm" onClick={() => onViewModeChange("cards")} className={cn("h-8 w-8 p-0 rounded-none text-inherit bg-inherit", viewMode === "cards" && "bg-primary text-primary-foreground")} aria-label="Vista de tarjetas">
