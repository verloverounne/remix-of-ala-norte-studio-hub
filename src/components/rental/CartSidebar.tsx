...
export const CartSidebar = ({
  ...
  <>
      ...
      {/* Footer */}
      {items.length > 0 &&
    <div className="p-4 bg-muted/30 rounded-sm mx-[16px] ml-0 my-[32px]">
      ...
      <>
        ...
        <div className="fixed bottom-4 center z-40">
          <button
            ...
            {totalItems > 0 &&
            <span className="absolute -top-2 -right-2 text-destructive-foreground text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center bg-primary">
                {totalItems}
              </span>
            }
          </button>
  ...
  return (
    <div
      className="z-20 shadow-brutal border-px rounded-sm bg-transparent"
      style={{
        top: `${stickyTop}px`
      }}>
