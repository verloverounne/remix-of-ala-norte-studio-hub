...
export const CategorySection = forwardRef<CategorySectionRef, CategorySectionProps>(
  (
    ...
    const filteredEquipment =
      selectedSubcategory === "all" ? equipment : equipment.filter((e) => e.subcategory_id === selectedSubcategory);
    ...
    return (
      ...
      >
              ...
              <Select value={selectedSubcategory} onValueChange={setSelectedSubcategory}>
                ...
                <SelectContent className="bg-background z-50">
                  ...
                  {subcategories.map((sub) => (
                    <SelectItem key={sub.id} value={sub.id} className="font-heading text-xs sm:text-sm">
                      {sub.name}
                    </SelectItem>
                  ))}
                </SelectContent>
        ...
        {isExpanded && (
          <div ref={gridRef} className="p-3 sm:p-4 border-[#201e1d] border-0 px-0 bg-background max-w-screen-2xl ">
                  ...
                  return (
                    ...
                    >
                      <CardContent className="p-2 sm:p-3 flex flex-col space-y-2 px-[4px] bg-muted text-stone-200">
                        ...
                        <h3
                          className="font-heading normal-case text-xs leading-tight pt-2 line-clamp-2 cursor-pointer transition-colors h-[5em] sm:text-xs text-left font-medium text-foreground mx-[4px]"
