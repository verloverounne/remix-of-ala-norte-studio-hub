  ...
  (
    ...
    return (
      ...
      >
        ...
        {isExpanded && (
          <div ref={gridRef} className="border-[#201e1d] border-0 bg-background max-w-screen-xl px-[4px] mx-0">
            {equipment.length === 0 ? (
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
                          {group.items.map((item) => {
                            ...
                            return (
                              ...
                              >
                                <CardContent className="p-2 sm:p-3 flex flex-col space-y-2 px-[4px] text-stone-200 rounded-sm bg-popover">
                                  <h3
                                  ...
                                  >
                                    ...
                                    {item.image_url ? (
                                      ...
                                      <div className="w-full h-full flex items-center justify-center bg-secondary text-accent">
                                        <span className="text-2xl sm:text-3xl opacity-20 font-heading bg-transparent">
                                          ?
                                        </span>
                                      </div>
                                    )}
