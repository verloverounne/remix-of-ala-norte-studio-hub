      ...
      {equipment.map((item) => {
        ...
        return (
          ...
          >
            {/* Thumbnail */}
            <div
              className="w-12 h-12 sm:w-16 sm:h-16 flex-shrink-0 cursor-pointer overflow-hidden bg-muted"
            ...
            <Badge
              variant="secondary"
              className={cn(
                "flex-shrink-0 text-[10px] px-2 py-0.5 font-heading",
            ...
            {item.status === 'available' ? (
              <Button
                size="sm"
                className="h-8 w-8 p-0 flex-shrink-0 bg-[#fbf2ee]"
