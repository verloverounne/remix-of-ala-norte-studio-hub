          ...
          <CarouselContent className="-ml-0">
            ...
            return <CarouselItem key={category.id} className="pl-0 basis-full">
                  <div className="relative h-[75vh] overflow-hidden duotone-hover-group">
                    ...
                    {/* Text overlay */}
                    <div className="absolute inset-0 py-0 flex items-end justify-center">
                      <div className="text-center z-10 p-4 sm:p-8 max-w-4xl my-[93px]">
                        <h1 className="font-heading sm:text-3xl mb-2 uppercase drop-shadow-lg mx-0 font-extrabold lg:text-7xl text-primary text-7xl py-0 md:text-8xl px-0">
