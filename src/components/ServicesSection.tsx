      ...
      <div className="hidden lg:grid lg:grid-cols-2 h-full">
        ...
        <div className="flex-col h-full p-8 lg:p-12 xl:p-16 overflow-y-auto bg-background flex items-center justify-center">
          <div className="max-w full mx-4 mb:mx-16 lg:mx-24 text-foreground space-y-4">
            ...
            {(service.cta_label || service.button_text) && (service.cta_url || service.button_link) && <div className="pt-16 pb-64 w-full mx-px items-">
...
export const ServicesSection = () => {
  ...
  return <section className="relative bg-background">
      <div className="pb-[24px] px-0 text-foreground sm:py-[24px] py-0 pt-[32px] border-0 bg-[#131211]">
        <h2 className="pt-8 font-sans text-center text-sm mb:large lg:text-2xl xl:text-6x1 font-thin text-background bg-transparent mx-[3px] px-[16px] my-[16px] max-w-lg">
