  ...
  return (
    <section className="relative bg-background">
      <div className="pb-[24px] px-0 text-foreground sm:py-[24px] py-0 pt-[32px] border-0 bg-background items -enter">
        <h2
          className="pt-8 font-sans text-center font-thin text-background bg-transparent max-w-lg my-0 mx-0 px-[32px]"
          ...
          <div className={cn("hidden sm:flex items-center justify-between gap-0", dropdownOpen && "hidden")}>
            {services.map((service, index) => (
              <button
                ...
                className={cn(
                  "flex-1 font-heading text-xs transition-all rounded-none shadow-none px-0 py-[16px] my-[16px]",
                  activeIndex === index
