  ...
  return (
    <div className="flex-[0_0_100%] min-w-0 h-dvh">
      ...
      <div className="hidden lg:grid lg:grid-cols-2 h-5/6">
        ...
        <div className="flex-col h-full p-8 lg:p-12 xl:p-16 overflow-y-auto flex items-center justify-center bg-background py-0">
              ...
              <ul className="space-y-2 mb-4">
                {service.bullets.map((bullet, i) => (
                  <li key={i} className="flex items-start gap-2">
                    <span className="text-xs text-background text-gray-950">{bullet}</span>
                  </li>
                ))}
              </ul>
            )}
