  ...
  return <div className="flex-[0_0_100%] min-w-0 h-screen">
      ...
      <div className="hidden lg:grid lg:grid-cols-2 h-full">
        ...
        <div ref={mediaParallax.ref as any} className="h-full overflow-hidden relative duotone-hover-group bg-muted">
          {hasMedia ? isVideo ? <video ref={videoRef} src={mediaUrl!} className="video-duotone absolute left-0 top-0 w-full h-9/10 object-cover bg-background border-0" style={{
          ...mediaParallax.style
