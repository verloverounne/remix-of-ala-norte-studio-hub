      ...
      <div ref={containerRef} className="lg:hidden h-[130vh] relative">
        ...
        ...contentStyle
          ...
          <div className="h-screen pb-8 px-4 flex items-center justify-center">
            <div className="backdrop-blur-2x1 bg-[#423c38]/70 p-6 w-full text-foreground max-h-[80vh] overflow-y-auto mx-4 lg-32 xl-64 pointer-events-auto mb-0">
  ...
  useEffect(() => {
    const fetchServices = async () => {
      ...
      const { data, error } = await supabase
        .from("home_services")
        .select("id, title, description, image_url, section_media_type, section_video_url, button_text, button_link, bullets, cta_label, cta_url, order_index, is_active")
        .eq("is_active", true)
        .order("order_index");
