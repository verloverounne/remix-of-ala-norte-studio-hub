  ...
  "inline-flex items-center border-2 border-foreground px-3 py-1 text-xs font-heading uppercase tracking-wider transition-none focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "bg-[#70DDB0] text-foreground border-2 border-foreground font-bold tracking-wider hover:shadow-brutal-sm hover:-translate-x-0.5 hover:-translate-y-0.5",
      },
    },
    defaultVariants: {
      variant: "default",
